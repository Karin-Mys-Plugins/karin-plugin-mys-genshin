...
export const UpdataBaseRes = karin.command(
  ...
  async (e) => {
    const source = Cfg.get(`resources.${ResourceTypeEnum.BaseRes}.source`)
    ...
    if (source === ResourceSourceEnum.UnSet) {
      ...
      switch (parseInt(ctx.msg.trim())) {
        case 1:
          Cfg.set(`resources.${ResourceTypeEnum.BaseRes}.source`, ResourceSourceEnum.GitHub, true)
          break
        case 2:
          Cfg.set(`resources.${ResourceTypeEnum.BaseRes}.source`, ResourceSourceEnum.GitHubProxy, true)
          break
        case 3:
          Cfg.set(`resources.${ResourceTypeEnum.BaseRes}.source`, ResourceSourceEnum.GitCode, true)
          break
        case 4: {
          e.reply('请发送自定义资源链接。')
          ...
          Cfg.set(`resources.${ResourceTypeEnum.BaseRes}`, { source: ResourceSourceEnum.Custom, customUrl: ctx1.msg.trim() }, true)
    ...
    e.reply(`正在更新『${GenshinGame.name}』 基础资源 (Source: ${Cfg.get(`resources.${ResourceTypeEnum.BaseRes}.source`)})，请稍候……`)
